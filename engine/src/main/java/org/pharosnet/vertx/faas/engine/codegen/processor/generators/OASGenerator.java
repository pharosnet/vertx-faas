...
import org.pharosnet.vertx.faas.engine.codegen.annotation.oas.ServerVariable;
...
public class OASGenerator {
    ...
    private OpenAPI buildOpenAPI(Map<String, List<Element>> moduleFnMap, EnableOAS enableOAS) throws Exception {
        ...
        for (org.pharosnet.vertx.faas.engine.codegen.annotation.oas.Server server : enableOAS.servers()) {
