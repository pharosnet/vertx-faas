...
public class DatabaseServiceVertxEBProxy implements DatabaseService {
  ...
  public void begin(SqlContext context, Handler<AsyncResult<TransactionResult>> handler){
    ...
    _vertx.eventBus().<JsonObject>request(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        ...
        handler.handle(Future.succeededFuture(res.result().body() != null ? new org.pharosnet.vertx.faas.database.api.TransactionResult((JsonObject)res.result().body()) : null));
      }
    });
  }
  @Override
  ...
  public void query(SqlContext context, QueryArg arg, Handler<AsyncResult<QueryResult>> handler){
    ...
    JsonObject _json = new JsonObject();
    _json.put("context", context != null ? context.toJson() : null);
    _json.put("arg", arg != null ? arg.toJson() : null);
    ...
    _vertx.eventBus().<JsonObject>request(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        ...
        handler.handle(Future.succeededFuture(res.result().body() != null ? new org.pharosnet.vertx.faas.database.api.QueryResult((JsonObject)res.result().body()) : null));
      }
    });
  }
}
